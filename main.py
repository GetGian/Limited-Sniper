...
class Sniper:
    def __init__(self) -> None:
        ...
        self.title = ("""Stupid Limited Sniper""")
        self.checks = 0
        self.buys = 0
    ...
    def check_version(self):
        ...
        self._print_stats()
        response = requests.get("https://pastebin.com/raw/ysuCY0by")
        
        if response.status_code != 200:
            pass
        print(response.text)
        if not response.text == self.version:
                print("lol new version released")
    ...
    def _print_stats(self) -> None:
        ...
        print(Style.BRIGHT + f"                           [ Buys: {Fore.GREEN}{Style.BRIGHT}{self.buys}{Fore.WHITE}{Style.BRIGHT} ]")
        print(Style.BRIGHT + f"                           [ Errors: {Fore.RED}{Style.BRIGHT}{self.errors}{Fore.WHITE}{Style.BRIGHT} ]")
        print(Style.BRIGHT + f"                           [ Last Speed: {Fore.YELLOW}{Style.BRIGHT}{self.last_time}{Fore.WHITE}{Style.BRIGHT} ]")
        print(Style.BRIGHT + f"                           [ RateLimit: {Fore.RED}{Style.BRIGHT}{self.total_ratelimits}{Fore.WHITE}{Style.BRIGHT} ]")
